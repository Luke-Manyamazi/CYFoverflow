...
const AskQuestionPage = () => {
  ...
  const handleBackToSelection = () => {
    if (window.confirm("Going back will clear your current progress. Are you sure?")) {
      ...
      <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-5xl w-full space-y-10 animate-fade-in">
          ...
          <div className="text-center">
            <h2 className="text-4xl font-extrabold text-gray-900 mb-4">What kind of question do you have?</h2>
            <p className="text-lg text-gray-600">Select a template to help us help you faster.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {TEMPLATES.map((template) => (
              ...
              >
                ...
                <h3 className={`text-xl font-bold mb-3 ${template.textColor || 'text-gray-900'}`}>
                  {template.title}
                </h3>
          ...
          <div className="text-center pt-8">
            <button onClick={() => navigate(-1)} className="text-gray-500 hover:text-gray-700 underline">
                Cancel and go back
            </button>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 space-y-6 animate-fade-in">
            ...
            <div className="text-center border-b border-gray-100 pb-6">
                ...
                <div className="inline-flex items-center px-3 py-1 rounded-full bg-gray-100 text-xs font-medium text-gray-600 mt-2">
                    Using Template: <span className="font-bold ml-1">{TEMPLATES.find(t => t.id === activeTemplate)?.title}</span>
                </div>
            </div>
                    ...
                    <div className="rounded-lg overflow-hidden border-2 border-gray-200 focus-within:border-[#281d80] focus-within:ring-2 focus-within:ring-[#281d80]/20 transition-all">
                        <Editor
                            ...
                            init={{
                                ...
                                toolbar: 'undo redo | blocks | bold italic | bullist numlist | link | codesample',
                                extended_valid_elements: 'p[class|data-placeholder],li[class|data-placeholder],div[data-template]',
                                content_style: `
                                ...
                                setup: (editor) => {
                                    ...
                                    const togglePlaceholder = () => {
                                        const placeholders = editor.dom.select('.template-placeholder');
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setTemplateFields(prev => ({ ...prev, 'bug-report': { ...prev['bug-report'], browser: e.target.value } }))}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setTemplateFields(prev => ({ ...prev, 'bug-report': { ...prev['bug-report'], os: e.target.value } }))}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:border-[#281d80]"
                        />
                      </div>
                    </div>
                  ...
                  <div className="bg-green-50 border-l-4 border-green-600 p-6 rounded-r-lg space-y-4 animate-fade-in-down">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setTemplateFields(prev => ({ ...prev, 'how-to': { ...prev['how-to'], documentationLink: e.target.value } }))}
