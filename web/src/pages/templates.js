...
export const TEMPLATES = [
    {
        ...
        description: 'A standard template for most technical problems. Use this if you are unsure.',
        icon: '🧩', 
    ...
    },
    {
        ...
        description: 'Best for when you need guidance on how to build a specific feature or use a tool.',
        icon: '🛠️',
    ...
    },
    {
        id: 'bug-report',
        title: 'Bug Report',
        description: 'Found a glitch? Use this strict format to help others reproduce the issue.',
        icon: '🐛',
